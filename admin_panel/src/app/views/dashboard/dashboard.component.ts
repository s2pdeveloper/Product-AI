...
export class DashboardComponent implements OnInit {
    ...
    public lineChart2Labels: Array<any> = ["Jan", "February", "March", "April", "May", "June", "July"];
    ...
    public lineChart4Data: Array<any> = [
        {
            data: [11, 22, 34, 17, 9, 18, 1],
            label: "Engg Bridge",
        },
    ];
    public lineChart4Labels: Array<any> = ["Jan", "February", "March", "April", "May", "June", "July"];
    ...
    public brandBoxChartType: any = "line";
